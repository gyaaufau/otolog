...
abstract class AppLocalizations {
  ...
  /// Primary CTA on the final onboarding page
  ///
  /// In en, this message translates to:
  /// **'Start Tracking'**
  String get onboardingGetStarted;

  /// Small badge label shown on onboarding
  ///
  /// In en, this message translates to:
  /// **'OTOLOG SETUP'**
  String get onboardingBadge;

  /// Short eyebrow text for onboarding step one
  ///
  /// In en, this message translates to:
  /// **'BUILD YOUR BASELINE'**
  String get onboardingEyebrowOne;

  /// Title for the first onboarding step
  ///
  /// In en, this message translates to:
  /// **'Create a garage that stays easy to read.'**
  String get onboardingTitleOne;

  /// Description for the first onboarding step
  ///
  /// In en, this message translates to:
  ...
  /// Short eyebrow text for onboarding step two
  ///
  /// In en, this message translates to:
  /// **'KEEP THE WORK VISIBLE'**
  String get onboardingEyebrowTwo;
  ...
  /// Description for the second onboarding step
  ///
  /// In en, this message translates to:
  ...
  /// Short eyebrow text for onboarding step three
  ///
  /// In en, this message translates to:
  /// **'READ THE SIGNALS'**
  String get onboardingEyebrowThree;
  ...
  /// Description for the third onboarding step
  ///
  /// In en, this message translates to:
  ...
  /// Metric label for the first onboarding step
  ///
  /// In en, this message translates to:
  /// **'Garage profile'**
  String get onboardingMetricGarage;

  /// Metric label for the second onboarding step
  ///
  /// In en, this message translates to:
  /// **'Service history'**
  String get onboardingMetricHistory;

  /// Metric label for the third onboarding step
  ///
  /// In en, this message translates to:
  /// **'Maintenance insight'**
  String get onboardingMetricInsights;

  /// Title for the onboarding preferences step
  ///
  /// In en, this message translates to:
  /// **'Set your defaults before you start.'**
  String get onboardingPreferencesTitle;

  /// Description for the onboarding preferences step
  ///
  /// In en, this message translates to:
  ...
  /// Error message when the app store link cannot be opened
  ///
  /// In en, this message translates to:
