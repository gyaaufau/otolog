...
class _EditVehicleScreenState extends State<EditVehicleScreen> {
  ...
  Future<void> _loadVehicleData() async {
    await context.read<VehicleCubit>().loadVehicleWithServices(
      widget.vehicleId,
    );
    ...
    if (state is VehicleLoaded && state.vehicles.isNotEmpty) {
      ...
      setState(() {
        ...
        _existingImagePath = vehicle.imagePath;
      });
    }
  }
  ...
  Widget _buildImagePicker() {
    ...
    final displayImage =
        _imageFile ??
        (_existingImagePath != null ? File(_existingImagePath!) : null);
      ...
      body: BlocListener<VehicleCubit, VehicleState>(
        ...
        child: BlocBuilder<VehicleCubit, VehicleState>(
          builder: (context, state) {
            final isLoading = state is VehicleLoading || _isSubmitting;
